...
def init(C):
    ...
    #        data2[stock]['iopv']=data[stock]['askPrice'][0]-get_etf_iopv(stock)
        ...
        if over=='over' and type=='open' and a==0: 
            ...
            etf1000_code=   {'Stock':'10009641.SHO','Price':data2['10009641.SHO']['askPrice']}  
            print(current_time)
        ...
        if over=='over' and type=='close' and a==0: 
            ...
            etf1000_code=   {'Stock':'10009641.SHO','Price':data2['10009641.SHO']['bidPrice']}  
            print(current_time)
    ...
    C.stock_list = ["10009640.SHO","10009641.SHO"]
